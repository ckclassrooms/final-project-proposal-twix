  ...
  // const file = ""
    ...
    function submitButtonClick(event){
      ...
      if (city !== "Select One" && violation !== "Select One") { 
        ...
        alert("Please fill all required values (Fields marked with '*')")
        }
    }
      ...
      async function uploadDets(jsonObj) {
        ...
        imagePath.then((path)=>{
          ...
          const { data, error } = supabase.functions.invoke('submit_violation_2', {
            body:  JSON.stringify({
            "lat":jsonObj["lat"],
            "lon":jsonObj["lat"],

...
function LiveDb() {
    ...
    const [filter, setFilter] = useState({"violation_type": []});
            ...
            <div className="filterValues">
                {
                    ...
                    <br/>
                    <Button variant="primary" onClick={(event) => onAddButtonClicked(event, "time")}>Filter</Button></div>: null
                }
                {
                    ...
                    <Button variant="primary" onClick={(event) => onAddButtonClicked(event, "violationType")}>Filter</Button></div>: null
                }
                {
                    ...
                    <Button variant="primary" onClick={(event) => onAddButtonClicked(event, "city")}>Filter</Button></div> : null
                }
            </div>
        </div>
